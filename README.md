...
└── js/
    ...
    ├── theme.js            # Dark mode: baca/simpan preferensi, toggle tema
    ├── toast.js            # Notifikasi toast yang bisa dipanggil dari file JS mana pun
    ├── spinner.js          # Helper loading spinner (tombol) & skeleton (tabel)
    ├── validation.js       # Validasi form Profil (halaman Profil)
...
Setiap fungsi diberi komentar JSDoc singkat di atasnya.

## Pemolesan UI/UX (baru)
...
### Loading Spinner
- Tombol **Check-in/Check-out** dan **Simpan Perubahan** (Profil) menampilkan ikon spinner + teks "Menyimpan..." selagi proses berjalan (`js/spinner.js`).
