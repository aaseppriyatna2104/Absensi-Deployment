...
(function () {
  ...
  // Ubah record ("tanggal": "YYYY-MM-DD") menjadi data siap-pakai
  // siap-pakai untuk tabel & statistik.
  ...
  function renderTable(records) {
    ...
    if (!records.length) {
      tbody.innerHTML = `
        <tr>
          <td colspan="6" style="text-align:center; color: var(--color-text-faint); padding: var(--sp-6) 0;">
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (typeof db === "undefined") {
      tableBody.innerHTML = `
        <tr><td colspan="6" style="text-align:center; color: var(--color-text-faint); padding: var(--sp-6) 0;">
    ...
    // Real-time listener — dokumen baru dari attendance.js langsung
    ...
    db.collection("attendance")
      ...
      .onSnapshot((snapshot) => {
        ...
        tableBody.innerHTML = `
          <tr><td colspan="6" style="text-align:center; color: var(--color-red-600); padding: var(--sp-6) 0;">
